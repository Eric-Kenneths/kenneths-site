  ...
  <div>
    ...
    <div class="grid mt-0 flex flex-column lg:flex-row md:ml-7 lg:mx-7" style="background-color: var(--black)">
      ...
      <div class="flex-order-1 col-12 lg:flex-order-0 lg:col-6 xl:col-offset-1">
        <iframe class="map-sm map-md map-lg map-xl" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3055.4368878432765!2d-83.06143468465854!3d40.0210241875341!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88388de00d4929a7%3A0x8b990eb60680ac5d!2sKenneth&#39;s+Hair+Salons+%26+Day+Spas!5e0!3m2!1sen!2sus!4v1533572375113"></iframe>
      </div>
          ...
          <div class="col-12 flex justify-content-center xl:justify-content-start align-items-center">
            <div class="text-left sans-serif text-3xl lg:text-4xl xl:text-5xl" style="color: white">
              <a class="address" href="https://maps.google.com/?q=3134+Kingsdale+,+Upper+Arlington,+OH+43221" target="_blank">
                <a class="address" href="https://maps.apple.com/maps?q=3134+Kingsdale+,+Upper+Arlington,+OH+43221" target="_blank">
                  <div>
                    Kingsdale
                  </div>
  ...
  export default {
    ...
    setup() {
      ...
      async function getEmployees() {
        let employeeList = await getEmployeesByLocationWithSocialMedia('kd');
...
<style scoped>
  ...
  @media only screen and (min-width: 768px) {
    ...
    .parallax-banner-md {
      background-image: url('/static/locations/kd/bannerParallax.jpg');
    ...
    .parallax-location-md {
      background-image: linear-gradient(var(--tan), var(--light-tan));
  ...
  @media only screen and (min-width: 992px) {
    ...
    .parallax-location-lg {
      background-image: url('/static/locations/kd/otherParallax.jpg');
      background-attachment: fixed;
