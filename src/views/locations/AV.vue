  ...
  <div>
          ...
          <div class="col-12 lg:col-12 flex justify-content-center align-items-center">
            <div class="text-left sans-serif text-3xl md:text-3xl lg:text-4xl xl:text-5xl" style="color: white">
              <a class="address" href="https://maps.google.com/?q=7056+Hospital+Dr,+Dublin,+OH+43016" target="_blank">
                <a class="address" href="https://maps.apple.com/maps?q=7056+Hospital+Dr,+Dublin,+OH+43016" target="_blank">
                  <div>
                    Avery Square Center
                  </div>
    ...
    <div class="grid parallax-location-md parallax-location-lg parallax-location-xl mt-4 md:mt-0 md:ml-7 lg:mr-7 lg:ml-4 xl:p-8">
      ...
      <div class="col-12 flex justify-content-center md:flex-order-1 md:justify-content-end md:align-items-center md:col-6 lg:justify-content-start lg:align-items-center lg:pl-8">
        <img src="/src/assets/locations/av/regularImage.jpg" alt="creative" class="photo-location-sm photo-location-md photo-location-lg photo-location-xl hidden md:block">
      </div>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    setup() {
      ...
      async function getEmployees() {
        let employeeList = await getEmployeesByLocationWithSocialMedia('av');
...
<style scoped>
  ...
  @media only screen and (min-width: 768px) {
    ...
    .parallax-banner-md {
      background-image: url('/src/assets/locations/av/bannerParallax.jpg');
  ...
  @media only screen and (min-width: 992px) {
    ...
    .parallax-location-lg {
      background-image: url('/src/assets/locations/av/otherParallax.jpg');
      background-attachment: fixed;
