  ...
  <div>
    ...
    <div class="grid parallax-location-lg parallax-location-xl mt-4 md:mt-0 md:ml-7 lg:mr-7 lg:ml-8 xl:px-8">
      ...
      <div class="col-12 flex justify-content-center md:flex-order-1 md:justify-content-end md:align-items-center md:col-5 lg:col-6 lg:justify-content-start lg:align-items-center lg:pl-8">
        <img src="/static/locations/av/regularImage.jpg" alt="creative" class="photo-location-sm photo-location-md photo-location-lg photo-location-xl hidden lg:block">
      </div>
    </div>
  </div>
</template>
...
<style scoped>
  ...
  @media only screen and (min-width: 768px) {
    ...
    .parallax-banner-md {
      background-image: url('/static/locations/av/bannerParallax.jpg');
  ...
  @media only screen and (min-width: 992px) {
    ...
    .parallax-location-lg {
      background-image: url('/static/locations/av/otherParallax.jpg');
      background-attachment: fixed;
