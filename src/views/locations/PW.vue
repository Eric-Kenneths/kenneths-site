  ...
  export default {
    ...
    setup() {
      ...
      async function getEmployees() {
        let employeeList = await getEmployeesByLocationWithSocialMedia('pw');
...
<style scoped>
  ...
  @media only screen and (min-width: 768px) {
    ...
    .parallax-banner-md {
      background-image: url('/src/assets/locations/pw/bannerParallax.jpg');
  ...
  @media only screen and (min-width: 992px) {
    ...
    .parallax-location-lg {
      background-image: url('/src/assets/locations/pw/otherParallax.jpg');
      background-attachment: fixed;
